...
import { questionsInRubrique } from "../types"
...
const RubriqueComposeView = () => {
    ...
    const [rubriqueItems, setRubriqueItems] = useState<questionsInRubrique[]>(
                    ...
                    {(provided: any) => (
                        ...
                        >
                            {rubriqueItems.map((item, index: number) => (
                                <Draggable
                                    key={String(item.idQuestion)}
                                    draggableId={String(item.idQuestion)}
                                    index={index}
                                >
                                    {(provided: any) => (
                                        <ListItem
